...
This library is just a fork of [jwt-redis](https://github.com/Natashkinsasha/jwt-redis-v2) that uses keyv as client for tokens storage. readme is an adapted copy of original one.
